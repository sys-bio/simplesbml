...
.. class:: sbmlModel(self, time_units='second', extent_units='mole', sub_units='mole', level=3, version=1)
    ...
    *model*, the 
    ...
    .. function:: addCompartment(self, vol=1e-15, comp_id='')
    
        Adds a `Compartment <http://sbml.org/Software/libSBML/docs/python-api/classlibsbml_1_1_compartment.html>`_ 
        of volume *vol* litres to the model.  The default volume is 1e-15 litres, 
        which is the volume of the average E.coli cell.  If the user does
    ...
    .. function:: toSBML(self)
       ...
       Returns the model in SBML format as a string.
